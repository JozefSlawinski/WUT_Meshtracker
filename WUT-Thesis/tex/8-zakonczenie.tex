...
Jak wynika z otwartego kodu firmware'u Meshtastic\footnote{Meshtastic Firmware. Repozytorium:
\url{https://github.com/meshtastic/firmware}.} oraz opisu API modułów\footnote{Module API.
Dostępne pod adresem: \url{https://meshtastic.org/docs/development/device/module-api/}},
częstotliwością raportowania pozycji sterują dwa oddzielne ustawienia. Jedno ustala, jak często moduł GPS
