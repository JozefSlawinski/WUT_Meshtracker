...
\textbf{Zalety.} Architektura mesh nie ogranicza zasięgu systemu do pojedynczego łącza
...
\textbf{Ograniczenia.} Osiągnięty zasięg efektywny (889--2278~m, zależnie od konfiguracji
...
z~liczbą węzłów pośredniczących, a~zasięg systemów punkt-punkt jest stały. Co istotne, konfiguracja
...
niedoskonałości algorytmu ray casting - jest to ograniczenie sprzętowo-protokołowe (firmware
Meshtastic), a~nie implementacyjne. Ochrona obudowy węzła mobilnego (IP65) jest niższa niż
w~rozwiązaniach komercyjnych (IPX9K, IP68).
...
\begin{itemize}
    ...
    \item \textbf{Podniesienie klasy szczelności obudowy} węzła mobilnego do poziomu porównywalnego
          z~rozwiązaniami komercyjnymi (IP68).
