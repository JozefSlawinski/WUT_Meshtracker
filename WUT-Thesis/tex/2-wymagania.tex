...
Dla porównania, komercyjne systemy śledzenia psów myśliwskich (opisane w rozdz.~\ref{sec:przeglad-istniejacych-rozwiazan}) osiągają zasięgi od 14~km (Dogtra Pathfinder~2)
...
Środowisko myśliwskie zna wiele rozwiązań dla utrzymywania psów w ściśle zdefiniowanych obszarach.
Rozważając jedynie elektroniczne produkty, przedstawiono tutaj wybrane tj. takie, które zostały najlepiej dopracowane.
...
Poza tym aplikacja umożliwia nagrywanie lokalizacji w sesje do późniejszego odtworzenia, nawigację
...
\begin{enumerate}
    ...
    \item \textbf{E-Fence} - statyczna konfiguracja ogrodzenia wysyłająca psu automatyczną
          korektę i powiadomienie~\cite[s.~26]{dogtraManual}.
\end{enumerate}
...
internetowej~\cite{dogtraceX25} dowiadujemy
się, że:
\begin{itemize}
...
\begin{table}[!h]
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        Aktualizacja pozycji    & co 2~s      & brak danych & $\leq$5~s \\
