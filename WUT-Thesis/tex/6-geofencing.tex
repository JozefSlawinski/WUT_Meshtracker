...
Android ~\footnote{\url{https://developer.android.com/develop/sensors-and-location/location/geofencing}} do monitorowania przekroczeń granic geograficznych. Szybko okazało się jednak, że rozwiązanie to monitoruje
